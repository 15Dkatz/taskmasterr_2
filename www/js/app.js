...
var myApp = angular.module('starter', ['ionic', 'starter.controllers', 'starter.services', 'auth0', 'angular-storage', 'angular-jwt', 'firebase', 'ngFileUpload'])
...
.config(function($stateProvider, $urlRouterProvider, authProvider,
  ...
  // Configure Auth0
  authProvider.init({
    domain: 'davidjtkatz.auth0.com',
    clientID: '2M1QhpEYpb0ybNse4HOTweQm9JcdgWul',
    loginState: 'login'
  });
